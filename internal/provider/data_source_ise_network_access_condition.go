...
var (
	_ datasource.DataSource              = &NetworkAccessConditionDataSource{}
	_ datasource.DataSourceWithConfigure = &NetworkAccessConditionDataSource{}
)

func NewNetworkAccessConditionDataSource() datasource.DataSource {
	return &NetworkAccessConditionDataSource{}
}
...
func (d *NetworkAccessConditionDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_network_access_condition"
}

func (d *NetworkAccessConditionDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the Network Access Condition.",
...
func (d *NetworkAccessConditionDataSource) ConfigValidators(ctx context.Context) []datasource.ConfigValidator {
...
func (d *NetworkAccessConditionDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
//template:begin read
func (d *NetworkAccessConditionDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config NetworkAccessCondition
