...
var (
	_ datasource.DataSource              = &DeviceAdminAuthorizationExceptionRuleDataSource{}
	_ datasource.DataSourceWithConfigure = &DeviceAdminAuthorizationExceptionRuleDataSource{}
)

func NewDeviceAdminAuthorizationExceptionRuleDataSource() datasource.DataSource {
	return &DeviceAdminAuthorizationExceptionRuleDataSource{}
}
...
func (d *DeviceAdminAuthorizationExceptionRuleDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the Device Admin Authorization Exception Rule.",
...
func (d *DeviceAdminAuthorizationExceptionRuleDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
//template:begin read
func (d *DeviceAdminAuthorizationExceptionRuleDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config DeviceAdminAuthorizationExceptionRule
