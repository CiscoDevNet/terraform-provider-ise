...
var (
	_ datasource.DataSource              = &TACACSCommandSetDataSource{}
	_ datasource.DataSourceWithConfigure = &TACACSCommandSetDataSource{}
)

func NewTACACSCommandSetDataSource() datasource.DataSource {
	return &TACACSCommandSetDataSource{}
}
...
func (d *TACACSCommandSetDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
...
func (d *TACACSCommandSetDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		MarkdownDescription: "This data source can read the TACACS Command Set.",
		...
		Attributes: map[string]schema.Attribute{
			...
			"name": schema.StringAttribute{
				MarkdownDescription: "The name of the TACACS command set",
				Optional:            true,
				Computed:            true,
			},
			...
			"permit_unmatched": schema.BoolAttribute{
				MarkdownDescription: "Permit unmatched commands",
				Computed:            true,
			},
