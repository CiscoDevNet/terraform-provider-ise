...
var (
	_ datasource.DataSource              = &NetworkAccessAuthorizationGlobalExceptionRuleDataSource{}
	_ datasource.DataSourceWithConfigure = &NetworkAccessAuthorizationGlobalExceptionRuleDataSource{}
)

func NewNetworkAccessAuthorizationGlobalExceptionRuleDataSource() datasource.DataSource {
	return &NetworkAccessAuthorizationGlobalExceptionRuleDataSource{}
}
...
func (d *NetworkAccessAuthorizationGlobalExceptionRuleDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the Network Access Authorization Global Exception Rule.",
...
func (d *NetworkAccessAuthorizationGlobalExceptionRuleDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
//template:begin read
func (d *NetworkAccessAuthorizationGlobalExceptionRuleDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config NetworkAccessAuthorizationGlobalExceptionRule
