...
var (
	_ datasource.DataSource              = &DeviceAdminPolicySetDataSource{}
	_ datasource.DataSourceWithConfigure = &DeviceAdminPolicySetDataSource{}
)

func NewDeviceAdminPolicySetDataSource() datasource.DataSource {
	return &DeviceAdminPolicySetDataSource{}
}
...
func (d *DeviceAdminPolicySetDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
...
func (d *DeviceAdminPolicySetDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the Device Admin Policy Set.",
...
func (d *DeviceAdminPolicySetDataSource) ConfigValidators(ctx context.Context) []datasource.ConfigValidator {
...
func (d *DeviceAdminPolicySetDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
//template:begin read
func (d *DeviceAdminPolicySetDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config DeviceAdminPolicySet
