...
func TestAccDataSourceIseNetworkAccessAuthorizationGlobalExceptionRule(t *testing.T) {
	var checks []resource.TestCheckFunc
	checks = append(checks, resource.TestCheckResourceAttr("data.ise_network_access_authorization_global_exception_rule.test", "name", "Rule1"))
	checks = append(checks, resource.TestCheckResourceAttr("data.ise_network_access_authorization_global_exception_rule.test", "default", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.ise_network_access_authorization_global_exception_rule.test", "rank", "0"))
	checks = append(checks, resource.TestCheckResourceAttr("data.ise_network_access_authorization_global_exception_rule.test", "state", "enabled"))
	checks = append(checks, resource.TestCheckResourceAttr("data.ise_network_access_authorization_global_exception_rule.test", "condition_type", "ConditionAttributes"))
	checks = append(checks, resource.TestCheckResourceAttr("data.ise_network_access_authorization_global_exception_rule.test", "condition_is_negate", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.ise_network_access_authorization_global_exception_rule.test", "condition_attribute_name", "Location"))
...
const testAccDataSourceIseNetworkAccessAuthorizationGlobalExceptionRulePrerequisitesConfig = `
...
func testAccDataSourceIseNetworkAccessAuthorizationGlobalExceptionRuleConfig() string {
