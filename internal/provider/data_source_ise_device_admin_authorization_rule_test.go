...
func TestAccDataSourceIseDeviceAdminAuthorizationRule(t *testing.T) {
	var checks []resource.TestCheckFunc
	checks = append(checks, resource.TestCheckResourceAttr("data.ise_device_admin_authorization_rule.test", "name", "Rule1"))
	checks = append(checks, resource.TestCheckResourceAttr("data.ise_device_admin_authorization_rule.test", "default", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.ise_device_admin_authorization_rule.test", "rank", "0"))
	checks = append(checks, resource.TestCheckResourceAttr("data.ise_device_admin_authorization_rule.test", "state", "enabled"))
	checks = append(checks, resource.TestCheckResourceAttr("data.ise_device_admin_authorization_rule.test", "condition_type", "ConditionAttributes"))
	checks = append(checks, resource.TestCheckResourceAttr("data.ise_device_admin_authorization_rule.test", "condition_is_negate", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("data.ise_device_admin_authorization_rule.test", "condition_attribute_name", "Location"))
	checks = append(checks, resource.TestCheckResourceAttr("data.ise_device_admin_authorization_rule.test", "condition_attribute_value", "All Locations"))
...
const testAccDataSourceIseDeviceAdminAuthorizationRulePrerequisitesConfig = `
...
func testAccDataSourceIseDeviceAdminAuthorizationRuleConfig() string {
