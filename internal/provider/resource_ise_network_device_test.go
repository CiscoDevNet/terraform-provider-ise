...
func TestAccIseNetworkDevice(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("ise_network_device.test", "snmp_auth_password", "Cisco123"))
	checks = append(checks, resource.TestCheckResourceAttr("ise_network_device.test", "snmp_privacy_protocol", "AES256"))
	checks = append(checks, resource.TestCheckResourceAttr("ise_network_device.test", "snmp_privacy_password", "Cisco12345"))
