...
func TestAccIseNetworkDevice(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("ise_network_device.test", "authentication_encryption_key_wo_version", "1"))
	checks = append(checks, resource.TestCheckResourceAttr("ise_network_device.test", "authentication_encryption_key_format", "ASCII"))
	checks = append(checks, resource.TestCheckResourceAttr("ise_network_device.test", "authentication_message_authenticator_code_key_wo_version", "1"))
	checks = append(checks, resource.TestCheckResourceAttr("ise_network_device.test", "authentication_network_protocol", "RADIUS"))
	checks = append(checks, resource.TestCheckResourceAttr("ise_network_device.test", "authentication_radius_shared_secret_wo_version", "1"))
	checks = append(checks, resource.TestCheckResourceAttr("ise_network_device.test", "authentication_enable_multi_secret", "true"))
	checks = append(checks, resource.TestCheckResourceAttr("ise_network_device.test", "authentication_second_radius_shared_secret_wo_version", "1"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("ise_network_device.test", "snmp_version", "THREE"))
	checks = append(checks, resource.TestCheckResourceAttr("ise_network_device.test", "snmp_username", "user123"))
	checks = append(checks, resource.TestCheckResourceAttr("ise_network_device.test", "snmp_security_level", "PRIV"))
	checks = append(checks, resource.TestCheckResourceAttr("ise_network_device.test", "snmp_auth_protocol", "SHA2"))
	checks = append(checks, resource.TestCheckResourceAttr("ise_network_device.test", "snmp_auth_password_wo_version", "1"))
	checks = append(checks, resource.TestCheckResourceAttr("ise_network_device.test", "snmp_privacy_protocol", "AES256"))
	checks = append(checks, resource.TestCheckResourceAttr("ise_network_device.test", "snmp_privacy_password_wo_version", "1"))
	checks = append(checks, resource.TestCheckResourceAttr("ise_network_device.test", "tacacs_connect_mode_options", "OFF"))
	checks = append(checks, resource.TestCheckResourceAttr("ise_network_device.test", "tacacs_shared_secret_wo_version", "1"))
	checks = append(checks, resource.TestCheckResourceAttr("ise_network_device.test", "trustsec_device_id", "device123"))
	checks = append(checks, resource.TestCheckResourceAttr("ise_network_device.test", "trustsec_device_password_wo_version", "1"))
	checks = append(checks, resource.TestCheckResourceAttr("ise_network_device.test", "trustsec_rest_api_username", "user123"))
	checks = append(checks, resource.TestCheckResourceAttr("ise_network_device.test", "trustsec_rest_api_password_wo_version", "1"))
	checks = append(checks, resource.TestCheckResourceAttr("ise_network_device.test", "trustsec_enable_mode_password_wo_version", "1"))
	checks = append(checks, resource.TestCheckResourceAttr("ise_network_device.test", "trustsec_exec_mode_password_wo_version", "1"))
