...
var (
	_ datasource.DataSource              = &ProfilerProfileDataSource{}
	_ datasource.DataSourceWithConfigure = &ProfilerProfileDataSource{}
)

func NewProfilerProfileDataSource() datasource.DataSource {
	return &ProfilerProfileDataSource{}
}

type ProfilerProfileDataSource struct {
	client *ise.Client
}
...
func (d *ProfilerProfileDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
//template:begin read
func (d *ProfilerProfileDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config ProfilerProfile
