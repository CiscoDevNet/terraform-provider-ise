...
var (
	_ datasource.DataSource              = &DeviceAdminConditionDataSource{}
	_ datasource.DataSourceWithConfigure = &DeviceAdminConditionDataSource{}
)

func NewDeviceAdminConditionDataSource() datasource.DataSource {
	return &DeviceAdminConditionDataSource{}
}
...
func (d *DeviceAdminConditionDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the Device Admin Condition.",
...
func (d *DeviceAdminConditionDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
//template:begin read
func (d *DeviceAdminConditionDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config DeviceAdminCondition
