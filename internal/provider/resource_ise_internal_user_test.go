...
func TestAccIseInternalUser(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("ise_internal_user.test", "password_wo_version", "1"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("ise_internal_user.test", "enable_password_wo_version", "1"))
