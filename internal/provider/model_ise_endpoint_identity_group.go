...
func (data *EndpointIdentityGroup) fromBody(ctx context.Context, res gjson.Result) {
	...
	if value := res.Get("EndPointGroup.description"); value.Exists() && value.Type != gjson.Null && value.String() != "" {
...
func (data *EndpointIdentityGroup) updateFromBody(ctx context.Context, res gjson.Result) {
	...
	if value := res.Get("EndPointGroup.description"); value.Exists() && !data.Description.IsNull() && value.String() != "" {
		data.Description = types.StringValue(value.String())
	} else {
		data.Description = types.StringNull()
	}
