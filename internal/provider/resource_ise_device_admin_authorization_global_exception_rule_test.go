...
func TestAccIseDeviceAdminAuthorizationGlobalExceptionRule(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("ise_device_admin_authorization_global_exception_rule.test", "condition_is_negate", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("ise_device_admin_authorization_global_exception_rule.test", "condition_attribute_name", "Location"))
...
const testAccIseDeviceAdminAuthorizationGlobalExceptionRulePrerequisitesConfig = `
...
func testAccIseDeviceAdminAuthorizationGlobalExceptionRuleConfig_minimum() string {
