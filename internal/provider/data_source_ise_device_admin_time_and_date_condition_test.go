...
func TestAccDataSourceIseDeviceAdminTimeAndDateCondition(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.ise_device_admin_time_and_date_condition.test", "week_days.0", "Monday"))
	checks = append(checks, resource.TestCheckResourceAttr("data.ise_device_admin_time_and_date_condition.test", "week_days_exception.0", "Tuesday"))
