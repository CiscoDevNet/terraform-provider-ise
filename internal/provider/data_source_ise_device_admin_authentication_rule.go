...
var (
	_ datasource.DataSource              = &DeviceAdminAuthenticationRuleDataSource{}
	_ datasource.DataSourceWithConfigure = &DeviceAdminAuthenticationRuleDataSource{}
)

func NewDeviceAdminAuthenticationRuleDataSource() datasource.DataSource {
	return &DeviceAdminAuthenticationRuleDataSource{}
}
...
func (d *DeviceAdminAuthenticationRuleDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
...
func (d *DeviceAdminAuthenticationRuleDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		// This description is used by the documentation generator and the language server.
		MarkdownDescription: "This data source can read the Device Admin Authentication Rule.",
		...
		Attributes: map[string]schema.Attribute{
			...
			"if_process_fail": schema.StringAttribute{
				MarkdownDescription: "Action to perform when ISE is unable to access the identity database",
				Computed:            true,
			},
...
func (d *DeviceAdminAuthenticationRuleDataSource) ConfigValidators(ctx context.Context) []datasource.ConfigValidator {
...
func (d *DeviceAdminAuthenticationRuleDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
...
//template:begin read
func (d *DeviceAdminAuthenticationRuleDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var config DeviceAdminAuthenticationRule
