...
func (p *IseProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		NewNetworkAccessAuthenticationRuleUpdateRanksResource,
		NewNetworkAccessAuthorizationExceptionRuleResource,
		NewNetworkAccessAuthorizationExceptionRuleUpdateRankResource,
		NewNetworkAccessAuthorizationExceptionRuleUpdateRanksResource,
		...
		NewNetworkAccessAuthorizationGlobalExceptionRuleUpdateRanksResource,
...
func (p *IseProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		NewEndpointCustomAttributeDataSource,
		...
		NewNetworkAccessDictionaryAttributeDataSource,
		...
		NewSXPConnectionDataSource,
		NewSXPDomainFilterDataSource,
		NewSXPLocalBindingDataSource,
		NewSXPVPNDataSource,
