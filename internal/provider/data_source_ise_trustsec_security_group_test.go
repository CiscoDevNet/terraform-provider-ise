...
func TestAccDataSourceIseTrustSecSecurityGroup(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.ise_trustsec_security_group.test", "description", "My SGT"))
	checks = append(checks, resource.TestCheckResourceAttr("data.ise_trustsec_security_group.test", "value", "1234"))
	checks = append(checks, resource.TestCheckResourceAttr("data.ise_trustsec_security_group.test", "propogate_to_apic", "true"))
