...
func TestAccIseDeviceAdminAuthenticationRuleUpdateRanks(t *testing.T) {
	var checks []resource.TestCheckFunc
	checks = append(checks, resource.TestCheckResourceAttr("ise_device_admin_authentication_rule_update_ranks.test", "rules.0.rank", "0"))
...
const testAccIseDeviceAdminAuthenticationRuleUpdateRanksPrerequisitesConfig = `
