...
func TestAccDataSourceIseDeviceAdminPolicySet(t *testing.T) {
	var checks []resource.TestCheckFunc
	checks = append(checks, resource.TestCheckResourceAttr("data.ise_device_admin_policy_set.test", "name", "PolicySet1"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("data.ise_device_admin_policy_set.test", "condition_attribute_name", "Location"))
	checks = append(checks, resource.TestCheckResourceAttr("data.ise_device_admin_policy_set.test", "condition_attribute_value", "All Locations"))
	checks = append(checks, resource.TestCheckResourceAttr("data.ise_device_admin_policy_set.test", "condition_dictionary_name", "DEVICE"))
	checks = append(checks, resource.TestCheckResourceAttr("data.ise_device_admin_policy_set.test", "condition_operator", "equals"))
...
const testAccDataSourceIseDeviceAdminPolicySetPrerequisitesConfig = `
...
func testAccDataSourceIseDeviceAdminPolicySetConfig() string {
