...
func TestAccIseDeviceAdminCondition(t *testing.T) {
	var checks []resource.TestCheckFunc
	checks = append(checks, resource.TestCheckResourceAttr("ise_device_admin_condition.test", "name", "Cond1"))
	...
	if os.Getenv("SKIP_MINIMUM_TEST") == "" {
		steps = append(steps, resource.TestStep{
			Config: testAccIseDeviceAdminConditionConfig_minimum(),
		})
	}
	steps = append(steps, resource.TestStep{
		Config: testAccIseDeviceAdminConditionConfig_all(),
		Check:  resource.ComposeTestCheckFunc(checks...),
	})
	steps = append(steps, resource.TestStep{
		ResourceName: "ise_device_admin_condition.test",
		ImportState:  true,
	})
...
func testAccIseDeviceAdminConditionConfig_minimum() string {
...
func testAccIseDeviceAdminConditionConfig_all() string {
	config := `resource "ise_device_admin_condition" "test" {` + "\n"
	config += `	name = "Cond1"` + "\n"
