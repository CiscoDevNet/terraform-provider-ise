...
func TestAccIseNetworkAccessCondition(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("ise_network_access_condition.test", "description", "My description"))
	checks = append(checks, resource.TestCheckResourceAttr("ise_network_access_condition.test", "condition_type", "LibraryConditionAttributes"))
	checks = append(checks, resource.TestCheckResourceAttr("ise_network_access_condition.test", "is_negate", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("ise_network_access_condition.test", "attribute_name", "EapAuthentication"))
	checks = append(checks, resource.TestCheckResourceAttr("ise_network_access_condition.test", "attribute_value", "EAP-TLS"))
	checks = append(checks, resource.TestCheckResourceAttr("ise_network_access_condition.test", "dictionary_name", "Network Access"))
