...
func (data DeviceAdminAuthorizationRuleUpdateRank) getPath() string {
...
func (data DeviceAdminAuthorizationRuleUpdateRank) toBody(ctx context.Context, state DeviceAdminAuthorizationRuleUpdateRank) string {
	body := ""
...
func (data *DeviceAdminAuthorizationRuleUpdateRank) fromBody(ctx context.Context, res gjson.Result) {
...
func (data *DeviceAdminAuthorizationRuleUpdateRank) updateFromBody(ctx context.Context, res gjson.Result) {
...
func (data *DeviceAdminAuthorizationRuleUpdateRank) isNull(ctx context.Context, res gjson.Result) bool {
	if !data.RuleId.IsNull() {
		return false
	}
	if !data.Rank.IsNull() {
