...
func TestAccIseAuthorizationProfile(t *testing.T) {
	...
	checks = append(checks, resource.TestCheckResourceAttr("ise_authorization_profile.test", "vlan_name_id", "VLAN10"))
	checks = append(checks, resource.TestCheckResourceAttr("ise_authorization_profile.test", "vlan_tag_id", "0"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("ise_authorization_profile.test", "auto_smart_port", "PROFILE1"))
	checks = append(checks, resource.TestCheckResourceAttr("ise_authorization_profile.test", "interface_template", "TEMP1"))
	checks = append(checks, resource.TestCheckResourceAttr("ise_authorization_profile.test", "ipv6_acl_filter", "ACL1"))
	checks = append(checks, resource.TestCheckResourceAttr("ise_authorization_profile.test", "avc_profile", "PROF1"))
	checks = append(checks, resource.TestCheckResourceAttr("ise_authorization_profile.test", "asa_vpn", "1"))
	checks = append(checks, resource.TestCheckResourceAttr("ise_authorization_profile.test", "unique_identifier", "ID1234"))
	...
	checks = append(checks, resource.TestCheckResourceAttr("ise_authorization_profile.test", "voice_domain_permission", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("ise_authorization_profile.test", "neat", "false"))
	checks = append(checks, resource.TestCheckResourceAttr("ise_authorization_profile.test", "web_auth", "false"))
