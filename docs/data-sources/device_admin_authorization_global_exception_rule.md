...
page_title: "ise_device_admin_authorization_global_exception_rule Data Source - terraform-provider-ise"
subcategory: "Device Administration"
description: |-
  This data source can read the Device Admin Authorization Global Exception Rule.
---

# ise_device_admin_authorization_global_exception_rule (Data Source)
